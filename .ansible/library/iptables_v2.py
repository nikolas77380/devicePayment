...
def construct_rule(params):
    ...
    append_match_set(rule, params['match_set_type'])
...
def main():
    module = AnsibleModule(
        ...
        argument_spec=dict(
            ...
            match_set=dict(required=False,default=None, type='str'),
            match_set_type=dict(required=False,default=None, type='str'),
